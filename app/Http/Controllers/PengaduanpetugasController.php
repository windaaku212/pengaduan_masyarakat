...
class PengaduanpetugasController extends Controller
{
    public function index()
    {
        ...
        return view('backend.content.laporanpetugas.index', compact('pengaduans')); // Perbaikan disini
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.content.laporanpetugas.detail', compact('pengaduan'));
    }
    ...
    public function update(Request $request, pengaduan $pengaduan, $id)
    {
        ...
        return redirect()->to('/pengaduanpetugas')->with('success', 'Status Berhasil Diperbarui');
    }
    ...
    public function destroy(Pengaduan $pengaduan)
    {
        ...
        return redirect()->to('/pengaduanpetugas')->with('success', 'Data Berhasil Dihapus');
    }
}
